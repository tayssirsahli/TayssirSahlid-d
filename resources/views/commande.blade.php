...
<head>
    ...
    <title>Deco Dar Ziadia - Order</title>
                        ...
                        <div class="account-settings">
                            <div class="user-profile">
                                <div class="user-avatar">
                                    <img src="{{ asset('uploads') }}/{{ Auth()->user()->photo }}" alt="Maxwell Admin">
                                </div>
                                <h5 class="user-name">{{ Auth()->user()->name }}</h5>
                                <h6 class="user-email"><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                        data-cfemail="84fdf1efedc4c9e5fcf3e1e8e8aae7ebe9">{{ Auth()->user()->email }}</a>
                                </h6>
                            </div>
            ...
            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <h6 class="mt-3 mb-2 text-primary">Change the order address if you need</h6>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
